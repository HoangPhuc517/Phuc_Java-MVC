        ...
        try {
            ...
            if (cookies != null){
                ...
                for (Cookie cookie : cookies) {
                    //3. Get username and password from nam value
                    ...
                    if (result != null) {
                        ...
                        session.setAttribute("sessionreqUsername", result);
                        break;
                    }//end authentication is successully checked
                }//end for traverse cookies
            }//end cookies is exited
